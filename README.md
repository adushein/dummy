# Практическое занятие по созданию CI/CD конвейера в GitLab
...
* Дождитесь завершения работы конвейера. Если все прошло успешно конвейер перейдет в состояние "Passed"
